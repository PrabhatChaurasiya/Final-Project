...
namespace QuestionBankApp.Controllers
{
    ...
    {
        static List<Question_Table1> Searchedquestions = new List<Question_Table1>();
        ...
        {
            var context = new MiniProjectEntities1();
            var model = context.Question_Table1.Where((qn) => qn.Keyword == postedData.searchkeyword).FirstOrDefault();
